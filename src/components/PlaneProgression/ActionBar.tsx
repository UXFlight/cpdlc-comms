...
export default function ActionBar({
  ...
  return (
    <div className="fixed top-22 left-1/2 transform -translate-x-1/2 bg-black text-white backdrop-blur-md border border-white/20 rounded-xl shadow-lg px-6 py-4 z-50 flex flex-col items-center space-y-3">
